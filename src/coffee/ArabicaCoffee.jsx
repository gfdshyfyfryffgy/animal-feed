...
import c1 from "../assets/products/coffbeans.png";
...
export default function ArabicaCoffee() {
  useEffect(() => {
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between px-6 gap-8">
         ...
         ArabicaCoffee
          ...
          <div className="w-full md:w-1/2 flex justify-center" data-aos="fade-left">
            <img src={c1} alt="Garlic" className="object-contain" style={{ width: 410, height: 410 }} />
          </div>
        </div>
      </div>
      ...
      <div style={{ background: COLORS.accent, padding: "3rem 0" }}>
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 px-6">
          <div data-aos="fade-up">
            <h2 className="text-xl font-bold mb-3 text-[#40642C]">ArabicaCoffee Features</h2>
          ...
          <div data-aos="fade-up" data-aos-delay="150">
            <h2 className="text-xl font-bold mb-3" style={{ color: COLORS.heading }}>About ArabicaCoffee</h2>
            <p className="text-[1.07rem] font-medium" style={{ color: COLORS.heading, lineHeight: 1.7 }}>
              Our ArabicaCoffee products are stored under strict chilling conditions, locking flavor and extending shelf life. Ideal for bulk packaging, exports, and food processing.
            </p>
          </div>
        </div>
      </div>
